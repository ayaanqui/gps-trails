...
export class ExploreComponent implements OnInit {
  ...
  clickedItem(e: any) {
    ...
    var marker = new mapboxgl.Marker()
      .setLngLat([e.lon, e.lat]).setPopup(popup)
      .addTo(map);

    // trail marker
    var popup1 = new mapboxgl.Popup()
      .setText(e.subtrails[0].name)
      .addTo(map);

    var marker2 = new mapboxgl.Marker()
      .setLngLat([e.subtrails[0].longitude, e.subtrails[0].latitude]).setPopup(popup1)
      .addTo(map);

    var popup2 = new mapboxgl.Popup()
      .setText(e.subtrails[1].name)
      .addTo(map);

    var marker3 = new mapboxgl.Marker()
      .setLngLat([e.subtrails[1].longitude, e.subtrails[1].latitude]).setPopup(popup2)
      .addTo(map);

    var popup3 = new mapboxgl.Popup()
      .setText(e.subtrails[2].name)
      .addTo(map);

    var marker4 = new mapboxgl.Marker()
      .setLngLat([e.subtrails[2].longitude, e.subtrails[2].latitude]).setPopup(popup3)
      .addTo(map);
          ...
          'features': [
            {
              ...
              'geometry': {
                'type': 'LineString',
                'coordinates': e.subtrails[0].path
          ...
          'features': [
            {
              ...
              'geometry': {
                'type': 'LineString',
                'coordinates': e.subtrails[1].path
          ...
          'features': [
            {
              ...
              'geometry': {
                'type': 'LineString',
                'coordinates': e.subtrails[2].path
